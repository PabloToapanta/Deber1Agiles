...
Este estudio de caso se ocupa de la necesidad de la Universidad Técnica de Ambato, que consiste en desarrollar un sistema para gestionar y prestar laboratorios, dado el contexto actual. La dificultad primordial de este proyecto no solo radica en la complejidad de sus tareas (que van desde la reserva de espacios hasta el control transaccional de equipos y la elaboración de informes), sino también en una limitación importante y es que el sistema tiene que ser entregado en seis meses.

Para afrontar este reto, el equipo de trabajo ha organizado la planificación del proyecto analizando la factibilidad de dos enfoques de desarrollo iterativos y enfocados en la retroalimentación constante: el modelo de construcción de prototipos y el método conocido como \textbf{Desarrollo Rápido de Aplicaciones (RAD)}. Los dos enfoques enfatizan que los usuarios estén activamente involucrados desde etapas tempranas, surgiendo como marcos estratégicos de trabajo para garantizar el entendimiento de las necesidades y la entrega puntual del producto, lo que reduce el peligro de desviaciones en el calendario.
...
Para el desarrollo del Sistema de Gestión y Préstamo de Laboratorios de la Universidad Técnica de Ambato, se han identificado los siguientes interesados que interactuarán directa o indirectamente con la plataforma:
 \begin{itemize}
 	...
 	\item \textbf{Docente:} Usuarios que requieren reservar los espacios físicos (laboratorios) para sus prácticas académicas y solicitar el préstamo de equipos tecnológicos.
...
\end{itemize}
 ...
 \begin{itemize}
 	\item \textbf{Riesgo 1 (Transición de Datos):} Inconsistencias o pérdida de información durante la migración de los registros manuales o en papel hacia la nueva base de datos del sistema \cite[p.~345]{alvarez-pineda_implementacion_2026}.
 ...
 \end{itemize}
 \subsubsection{Requisitos que Necesitan Mayor Aclaración}
 Antes de iniciar los ciclos de diseño interactivo de la metodología RAD, es imperativo que la universidad (cliente) aclare los siguientes puntos operativos:
 \begin{itemize}
...
Siguiendo las directrices de la metodología RAD, el tiempo de entrega de 6 meses es inamovible. Para gestionar los cambios o nuevos requerimientos, se utilizarán iteraciones de duración especifica con el objetivo de mantener el impulso del desarrollo. \cite[p.~340]{purnamasari_rapid_2026}. Además, si una funcionalidad solicitada (como un cambio de alcance) excede el tiempo de desarrollo asignado, se aplicará un enfoque de implementación por fases: las funciones críticas se desplegarán primero para cumplir con el plazo, y las características secundarias se postergarán para actualizaciones futuras \cite[p.~340]{purnamasari_rapid_2026}.
 ...
 \begin{enumerate}
 	...
 	Según el cronograma general establecido, al finalizar el tercer mes el proyecto acaba de concluir las iteraciones de \textit{Diseño de Usuario} y se encuentra en las etapas iniciales de la fase de \textbf{Construcción} (codificación modular) \cite{purnamasari_rapid_2026}.
 	
 	\item \textbf{¿Qué documentos o productos deben modificarse?} \\
 	Se debe actualizar la Matriz de Requisitos (SRS) para incluir las normativas de protección de datos y el acceso al hardware del dispositivo (cámara). Además, se deben modificar los Prototipos UI/UX (para incluir las interfaces móviles) y el Modelo de Datos (para añadir cifrado de información sensible y almacenamiento de imágenes) \cite{alvarez-pineda_implementacion_2026}.
 	
 	\item \textbf{¿Qué actividades tendrían que repetirse?} \\
 	Es necesario ejecutar un ciclo iterativo rápido (caja de tiempo corta) de la fase de \textbf{Diseño de Usuario} \cite{purnamasari_rapid_2026}. Esto implica realizar prototipos de baja y alta fidelidad exclusivamente para las pantallas de la aplicación móvil y someter la arquitectura de la base de datos a una revisión de seguridad y privacidad.
 	
 	\item \textbf{¿Cómo afectaría el cambio al tiempo y al costo?} \\
 	En RAD, el tiempo es una restricción inamovible (6 meses). Por lo tanto, agregar un canal completamente nuevo (app móvil) y auditorías de seguridad incrementará el costo del proyecto, ya que obligará a asignar más recursos (desarrolladores adicionales) a los equipos paralelos para no retrasar la fase de construcción \cite{purnamasari_rapid_2026}. Si no hay presupuesto, el alcance web original debe reducirse.
 	
 	\item \textbf{¿La metodología permite incorporar el cambio fácilmente?} \\
 	\textbf{Sí.} A diferencia del modelo en Cascada, RAD está diseñado para ser flexible. El uso de iteraciones cortas, retroalimentación continua y desarrollo en módulos permite que los equipos absorban nuevos requerimientos sin colapsar la arquitectura de lo que ya se está construyendo \cite{radvilaite_integrating_2025, purnamasari_rapid_2026}.
 	
 	\item \textbf{¿Aceptarían el cambio inmediatamente, lo aplazarían o lo rechazarían?} \\
Se optará por una \textbf{aceptación condicionada bajo un enfoque de implementación por fases} \cite[p.~344]{purnamasari_rapid_2026}. 
\begin{itemize}
	\item Las \textbf{políticas de protección de datos} se aceptan e implementan de inmediato, ya que constituyen una directriz institucional crítica y obligatoria para la operación del sistema.
	\item La \textbf{aplicación móvil} se acepta pero se gestiona dividiendo su alcance dentro de los plazos establecidos: se propondrá desarrollar una Aplicación Web Progresiva (PWA) o utilizar herramientas de bajo código para acelerar la entrega \cite{radvilaite_integrating_2025}, enfocando el esfuerzo \textit{únicamente} en la toma de fotos para reportes. Si la universidad exige una aplicación nativa completa, esta se aplazará como una actualización programada para una fase posterior al cumplimiento de los seis meses \cite[p.~344]{purnamasari_rapid_2026}.
\end{itemize}
 	
 	\item \textbf{¿Qué procedimiento formal utilizarían para gestionarlo?} \\
 	Se convocará de urgencia a una sesión de Diseño Conjunto de Aplicaciones (JAD) con las autoridades, el departamento legal (por los datos sensibles) y los docentes. En esta reunión se expondrá el impacto en la caja de tiempo, se negociará el alcance del Producto Mínimo Viable (MVP) para la app móvil, y se firmará un acta de modificación de requerimientos para autorizar al equipo de Construcción a proceder bajo el nuevo esquema \cite{purnamasari_rapid_2026}.
 \end{enumerate}
 %% =========================================================================
